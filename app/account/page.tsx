...
export default function AccountPage() {
  ...
  const fetchOrders = useCallback(async () => {
    if (!user?.id) {
      console.log("No user ID, skipping orders fetch")
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <div className="flex items-center space-x-4">
                ...
                >
                  ...
                  <span className="bg-black text-white text-xs rounded-full px-2 py-1 min-w-[20px] h-5 flex items-center justify-center">
                    {cartCount}
                  </span>
                </button>
          ...
          <div className="md:hidden bg-white border-t border-gray-200">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <button
                onClick={handleSignOut}
                disabled={isSigningOut}
                className="flex items-center space-x-2 w-full text-left px-3 py-2 rounded-md text-base font-medium text-red-600 hover:bg-gray-50 disabled:opacity-50"
              >
                <LogOut className="w-4 h-4" />
                <span>{isSigningOut ? "Signing out..." : "Sign Out"}</span>
              </button>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg border-red-200">
                  ...
                  <Button
                    ...
                    onClick={handleSignOut}
                    disabled={isSigningOut}
                    className="text-red-600 border-red-200 hover:bg-red-50 bg-transparent disabled:opacity-50"
                  >
