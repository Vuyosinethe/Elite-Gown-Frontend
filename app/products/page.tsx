...
import { ShoppingCart, Heart, Menu, X, Star } from "lucide-react"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex space-x-2">
                      <Button variant="outline" className="flex-1 hover:bg-black hover:text-white">
        ...
        <div className="mt-16 text-center bg-gray-50 p-12 rounded-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/contact">
              <Button variant="outline" className="px-8 py-3 hover:bg-gray-100">
                Contact Us
              </Button>
            </Link>
          </div>
